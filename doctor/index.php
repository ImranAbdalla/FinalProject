...
.menu-toggle {
    position: fixed; /* Ensures the button stays in the same place */
    top: 20px; /* Distance from the top */
    left: 20px; /* Distance from the left */
    z-index: 1100; /* Places it above the sidebar and other content */
    background: none;
    border: none;
    font-size: 24px;
    cursor: pointer;
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>You can view your daily schedule, Reach Patients Appointment at home!<br><br>
                            </p>
...
function toggleMenu() {
    ...
    if (menu.style.display === 'block') {
        ...
        mainContent.classList.add('expanded'); // Expand content
    } else {
        menu.style.display = 'block';
        mainContent.classList.remove('expanded'); // Reset to default
    }
}
